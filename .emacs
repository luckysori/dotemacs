...
;; Add dotemacs directory to load-path
(add-to-list
 'load-path (file-name-directory (file-truename load-file-name)))
...
(straight-register-package 'org-download)
(when my/enable-org-download
  (use-package
   org-download
   :straight t
   :custom (org-download-display-inline-images nil)))

(straight-register-package 'org-tree-slide)
(when my/enable-org-tree-slide
...
(straight-register-package 'org-pomodoro)
(when my/enable-org-pomodoro
  (use-package
   org-pomodoro
   :custom
...
(straight-register-package 'magit-delta)
(when my/enable-magit
  (use-package
   magit-delta
   :straight t
...
(straight-register-package 'git-timemachine)
(when my/enable-magit
...
(straight-register-package 'pdf-tools)
(when my/enable-pdf-tools
  (use-package pdf-tools :config (pdf-tools-install)))

;;; add-node-modules-path:

(straight-register-package 'add-node-modules-path)
(when my/enable-add-node-modules-path
...
(straight-register-package 'ace-window)
(when my/enable-ace-window
  (use-package
   ace-window
   :straight t
   :bind ("M-o" . ace-window)
...
(straight-register-package 'expand-region)
(when my/enable-expand-region
  (use-package
   expand-region
   :straight t
...
(straight-register-package 'multiple-cursors)
(when my/enable-multiple-cursors
  (use-package
   multiple-cursors
   :straight t
...
(straight-register-package 'erc-highlight-nicknames)
(when my/enable-erc
  (use-package
   erc
   :straight (erc :type built-in)
   :init
   (and (use-package erc-highlight-nicknames :straight t)
...
(straight-register-package 'rust-mode)
(when my/enable-rust
  (use-package
   rust-mode
   :straight t
...
(straight-register-package 'cargo)
(when my/enable-rust
  (use-package
   cargo
   :straight t
...
(straight-register-package 'toml-mode)
(when my/enable-toml-mode
  (use-package toml-mode :straight t))

;;; Dart:

(straight-register-package 'dart-mode)
(when my/enable-dart-mode
  (use-package dart-mode :straight t))

(straight-register-package 'lsp-dart)
(when my/enable-dart-mode
...
(straight-register-package 'lsp-ui)
(when my/enable-lsp-ui
  (use-package
   lsp-ui
...
(straight-register-package 'lsp-tailwindcss)
(when my/enable-lsp-tailwindcss
  (use-package
   lsp-tailwindcss
   :after lsp-mode
...
(straight-register-package 'smartparens)
(when my/enable-smartparens
  (use-package
   smartparens
   :init
...
(straight-register-package 'diff-hl)
(when my/enable-diff-hl
  (use-package
   diff-hl
   :hook
...
(when my/enable-exec-path-from-shell
  (use-package
   exec-path-from-shell
   :config
...
(straight-register-package 'markdown-mode)
(when my/enable-markdown-mode
  (use-package
   markdown-mode
...
(straight-register-package 'flycheck)
(when my/enable-flycheck
  (use-package
   flycheck
...
(straight-register-package 'flycheck-color-mode-line)
(when my/enable-flycheck-color-mode-line
  (use-package
...
(straight-register-package 'winner)
(when my/enable-winner
  (use-package
   winner
   :config
...
(straight-register-package 'ibuffer)
(when my/enable-ibuffer
...
(straight-register-package 'projectile)
(when my/enable-projectile
  (use-package
   projectile
...
(straight-register-package 'elisp-def)
(when my/enable-elisp-def
  (use-package
   elisp-def
   :config
...
(straight-register-package 'elisp-autofmt)
(when my/enable-elisp-autofmt
  (use-package
   elisp-autofmt
...
(straight-register-package 'display-line-numbers)
(when my/enable-display-line-numbers
  (use-package
...
(when my/enable-yaml-mode
  (use-package yaml-mode))

;;; restclient-mode:

(straight-register-package 'restclient)
(when my/enable-restclient
  (use-package
   restclient
   :config
...
(straight-register-package 'yasnippet)
(when my/enable-yasnippet
  (use-package
   yasnippet
...
(straight-register-package '(eldoc :type built-in))
(when my/enable-eldoc
...
(when my/enable-cider
  (use-package cider))

;;; Enhanced help mode:

(straight-register-package 'helpful)
(when my/enable-helpful
  (use-package
   helpful
   :config
...
(straight-register-package 'dictionary)
(when my/enable-dictionary
  (use-package dictionary))

;;; PlantUML:

(straight-register-package 'plantuml-mode)
(when my/enable-plantuml-mode
  (use-package
   plantuml-mode
   :custom
...
(straight-register-package 'xterm-color)
(when my/enable-xterm-color
  (use-package xterm-color))

;;; olivetti:

(straight-register-package 'olivetti)
(when my/enable-olivetti
...
(straight-register-package 'git-link)
(when my/enable-git-link
...
(straight-register-package 'nix-mode)
(when my/enable-nix-mode
  (use-package nix-mode))

;;; go:

(straight-register-package 'go-mode)
(when my/enable-go-mode
  (use-package go-mode))
...
(straight-register-package 'moody)
(when my/enable-moody
  (use-package
   moody
   :config (moody-replace-mode-line-buffer-identification)))

(straight-register-package 'minions)
(when my/enable-minions
...
(straight-register-package 'edbi)
(when my/enable-edbi
  (use-package edbi)
...
(straight-register-package '(prolog :type built-in))
(when my/enable-prolog
  (use-package
   prolog
...
(straight-register-package 'just-mode)
(when my/enable-just-mode
  (use-package just-mode))

(straight-register-package 'justl)
(when my/enable-justl
  (use-package justl))

(straight-register-package 'gptel)
(when my/enable-gptel
  (use-package
   gptel
...
(straight-register-package 'which-key)
(when my/enable-which-key
  (use-package which-key))

;;; LSP mode for the LTEX Language Server:

(straight-register-package 'lsp-ltex)
(when my/enable-lsp-ltex
  (use-package
   lsp-ltex
   :hook
   (markdown-mode . lsp)
...
(straight-register-package 'rg)
(when my/enable-rg
  (use-package rg :custom (rg-group-result nil)))

;;; logview:

(straight-register-package 'logview)
(when my/enable-logview
  (use-package
   logview
   :custom
...
(straight-register-package 'docker)
(when my/enable-docker
  (use-package docker))

;;; envrc:

(straight-register-package 'envrc)
(when my/enable-envrc
  (use-package envrc :hook (after-init . envrc-global-mode)))

;;; Treesitter:

(straight-register-package '(treesit :type built-in))
(when my/enable-treesit
  (use-package
   treesit
...
(straight-register-package 'consult)
(when my/enable-consult
  (use-package
   consult
...
(straight-register-package 'consult-flycheck)
(when my/enable-consult-flycheck
  (use-package consult-flycheck))

;;; marginalia:

(straight-register-package 'marginalia)
(when my/enable-marginalia
  (use-package marginalia :ensure t :config (marginalia-mode 1)))

;;; orderless:

(straight-register-package 'orderless)
(when my/enable-orderless
  (use-package
   orderless
   :ensure t
...
(straight-register-package 'embark)
(when my/enable-embark
...
(straight-register-package 'wgrep)
(when my/enable-wgrep
  (use-package wgrep))
...
(straight-register-package
 '(vc-jj :type git :host codeberg :repo "emacs-jj-vc/vc-jj.el"))
(when my/enable-vc-jj
  (use-package
   vc-jj

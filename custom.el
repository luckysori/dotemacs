(custom-set-variables
 ...
 '(org-agenda-files '("~/work/org/tasks.org" "~/personal/general.org" "~/work/org/retro.org"
                      "~/work/org/scrum.org"))
 '(package-selected-packages '(helm-fuzzier tide typescript-mode lsp-ui helm-ag latex-mode
                                            LaTeX-mode company-latex latex-preview-pane
                                            company-auctex async forge dired-git-info dired diredfl
                                            volume restclient indium yaml-mode helm-org
                                            helm-projectile projectile adoc-mode dap-rust dap-mode
                                            helm-lsp company-lsp docker-tramp rjsx-mode
                                            flycheck-color-mode-line elfeed helm-rg json-mode avy
                                            smart-parens hippie hippie-expand electric-pair-mode
                                            ...
                                            company-quickhelp flymd exec-path-from-shell wget
                                            js2-mode diff-hl browse-kill-ring cargo company
                                            rust-mode haskell-mode which-key cl-lib multiple-cursors
                                            expand-region ace-window intero hindent emojify
                                            smooth-scrolling auctex pdf-tools geiser))
